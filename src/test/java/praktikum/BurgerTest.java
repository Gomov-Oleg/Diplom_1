...
public class BurgerTest {
    ...
    public void addIngredientTest() {
        ...
        assertEquals("Необходимый ингредиент не добавлен", List.of(ingredientSauce), burger.ingredients);
    }
    ...
    public void moveIngredientTest() { // Тест проверяет, что ингредиенты могут перемещаться
        ...
        assertEquals("Поменять местами ингредиенты не удалось", ingredientFilling, burger.ingredients.get(0));
    }
    ...
    public void getReceiptTest() {
        ...
        String ingredientSauceType = "sauce";
        String ingredientFillingType = "filling";
        String bunName = "Галактическая";
        String ingredientSauceName = "Очень острый";
        String ingredientFillingName = "Сосиска с Сатурна";
        float price = 150;
        ...
        String expected = "(==== " + bunName + " ====)\r\n"
                + "= " + ingredientSauceType + " " + ingredientSauceName + " =\r\n"
                + "= " + ingredientFillingType + " " + ingredientFillingName + " =\r\n"
                + "(==== " + bunName + " ====)\r\n"
                + "\r\nPrice: " + finalPrice + "\r\n";
